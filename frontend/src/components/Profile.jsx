    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-blue-100 flex flex-col items-center justify-start p-6 space-y-8">
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6 text-center">
        ...
        <div className="flex justify-center gap-4 mb-4">
          <button className="bg-blue-500 text-white px-4 py-1 rounded-full hover:bg-blue-600">Follow</button>
          <button className="bg-gray-200 text-gray-800 px-4 py-1 rounded-full hover:bg-gray-300">Message</button>
        </div>

        <p className="text-sm text-gray-600">{currentUser.followers} followers</p>
      </div>

      {/* Emissions Overview */}
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6 text-center">
        <h3 className="text-lg font-semibold text-gray-800 mb-4">Carbon Emissions Overview</h3>
        <div className="grid grid-cols-2 gap-4 text-sm text-gray-700 mb-6">
          ...
          <div>
            <p className="font-bold">{currentUser.emissions.wasteRecycled} kg</p>
            <p>Waste Recycled</p>
          </div>
          <div>
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6">
        <h2 className="text-lg font-bold text-gray-800 mb-4 text-center">Change Password</h2>
